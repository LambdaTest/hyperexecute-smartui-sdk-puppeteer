...
# How to run Puppeteer tests through SmartUI SDK on HyperExecute — TestMu AI (Formerly LambdaTest)
...
Download or Clone the code sample for the Puppeteer from the TestMu AI GitHub repository to run the tests on the HyperExecute.
