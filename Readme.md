# Run Puppeteer Tests with SmartUI SDK on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Puppeteer tests with SmartUI visual regression testing using HyperExecute. This sample shows how to configure Puppeteer + SmartUI SDK + HyperExecute to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-smartui-sdk-puppeteer && cd hyperexecute-smartui-sdk-puppeteer
npm install
```
